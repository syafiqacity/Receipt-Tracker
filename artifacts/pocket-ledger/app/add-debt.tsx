...
export default function AddDebtScreen() {
  ...
  const save = async () => {
    ...
    if (!personName.trim() || !description.trim() || !numeric) {
      setError('Add who, what for, and an amount.');
      return;
    }
    await addDebt({ personName: personName.trim(), description: description.trim(), amount: numeric });
    router.back();
  };
